  ...
  return (
    <div className="w-72 bg-card border-r shadow-lg">
      <div className="flex items-center justify-between p-4 border-b">
        <h3 className="font-semibold text-base">Library</h3>
        {onClose && (
            ...
            <div className="p-3 space-y-3">
              <Card className="p-3 space-y-2">
                ...
                <Button
                  ...
                  size="sm"
                  className="w-full h-7 text-xs"
                  disabled={uploadingIcon || !newIconName.trim() || !vendorId}
                  onClick={() => {
                    if (!vendorId) {
                      toast.error('Sign in or select a vendor before uploading icons');
                      return;
                    }
