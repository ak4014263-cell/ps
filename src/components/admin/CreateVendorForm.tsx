  ...
  const onSubmit = async (values: VendorFormValues) => {
    ...
    try {
      const vendorData = {
        ...
        country: 'India',
        description: values.businessName,
      };

      const result = await apiService.vendorsAPI.create(vendorData);
      ...
      form.reset();
      window.location.reload(); // Refresh to show new vendor
    } catch (error: any) {
      toast({
        title: 'Error',
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <FormField
                ...
                name="isMaster"
                render={({ field }) => (
                  <FormItem className="flex items-center space-x-2 space-y-0 md:col-span-2">
                    <FormControl>
                      <Checkbox
                        checked={field.value}
                    ...
                    <FormLabel className="!mt-0">Is Master Vendor</FormLabel>
                    <FormMessage />
                  </FormItem>
                )}
              />
            ...
            <Button type="submit" disabled={isLoading}>
              {isLoading ? 'Creating...' : 'Create Vendor Account'}
            </Button>
          </form>
        </Form>
      </CardContent>
