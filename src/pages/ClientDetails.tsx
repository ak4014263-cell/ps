...
export default function ClientDetails() {
  ...
  const { data: walletTransactions = [] } = useQuery({
    ...
    queryFn: async () => {
      ...
      // Show current balance as transaction history
      return [
        {
          id: '1',
  ...
  const initials = client.client_name?.split(' ').map(n => n[0]).join('').toUpperCase() || 'C';
        ...
        <CardContent className="p-6">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl font-bold">{client.company || client.client_name}</h1>
            ...
            <Button size="icon" variant="outline" onClick={() => setEditClientOpen(true)}>
              <Pencil className="h-4 w-4" />
            </Button>
          </div>
        </CardContent>
            ...
            <CardContent className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="font-medium">{client.institution || '-'}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="font-medium text-green-600">₹ {Number(client.balance || 0).toFixed(2)}</p>
                </div>
                <div>
                  <p className="text-sm text-muted-foreground">Credit Limit</p>
                  <p className="font-medium text-blue-600">₹ {Number(client.credit_limit || 0).toFixed(2)}</p>
                </div>
                <div>
