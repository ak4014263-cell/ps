...
/**
 * POST /api/image/upload-project-photo
 * multipart/form-data file field 'file'
 * optional form fields: projectId, fileName
 * Saves a photo to uploads/project-photos/{projectId}/{fileName}
 */
router.post('/upload-project-photo', upload.single('file'), async (req, res) => {
  try {
    if (!req.file) {
